                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.itemHsn}</TableCell>
                      <TableCell align="right">{row.purchasePrice}</TableCell>
                      <TableCell align="right">{row.itemMrp}</TableCell>
                      <TableCell align="right">{row.itemMsp}</TableCell>
                      <TableCell align="right">{row.itemMeasure}</TableCell>
                      <TableCell align="right">{row.itemGst}</TableCell>
